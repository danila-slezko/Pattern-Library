...
if (
  ...
  (Util.addClass = function (e, t) {
    ...
    e.classList
      ...
      1 < n.length && Util.addClass(e, n.slice(1).join(" "));
  }),
    ...
    var l = e - s,
      ...
      c = function (e) {
        ...
        var t = e - a,
          n = parseInt((t / i) * l + s);
        (o.style.height = n + "px"),
          t < i ? window.requestAnimationFrame(c) : r();
      };
...
(Math.easeInOutQuad = function (e, t, n, s) {
  ...
  (Math.easeOutElastic = function (e, t, n, s) {
    ...
    return (
      r * Math.pow(2, -10 * e) * Math.sin(((e * s - o) * (2 * Math.PI)) / i) +
      n +
      t
    );
  }),
  (function () {
    ...
    function t() {
      0 < s.length && (o(!1), window.addEventListener("keydown", n)),
  ...
  (function () {
      ...
      (this.element = e),
        ...
        (this.selectedOption = (function (e) {
          ...
          t =
            "selectedIndex" in e.select
              ? e.options[e.select.selectedIndex].text
              : e.select.querySelector("option[selected]").text;
          return t;
        })(this)),
        ...
        (function (e) {
          e.element.insertAdjacentHTML(
                  ...
                  for (var s = 0; s < e.optGroups.length; s++) {
                    var o = e.optGroups[s].getElementsByTagName("option"),
                      i =
                        ...
                        e.optGroups[s].getAttribute("label") +
                        "</span></li>";
                    n =
                      n +
            ...
            (e.trigger = e.element.getElementsByClassName(
              "js-select__button"
            )[0]),
            (e.customOptions = e.dropdown.getElementsByClassName(
              "js-select__item"
            )),
                ...
                (function (e, t) {
                  if (
                    ...
                    n && n.setAttribute("aria-selected", "false"),
                      ...
                      (e.trigger.getElementsByClassName(
                        "js-select__label"
                      )[0].textContent = t.textContent),
                      e.trigger.setAttribute("aria-expanded", "false"),
                      (s = e),
                      (o = t.getAttribute("data-index")),
                      (s.select.selectedIndex = o),
                      s.select.dispatchEvent(
          ...
          t.dropdown.addEventListener("keydown", function (e) {
            ...
            t.element.addEventListener("select-updated", function (e) {
              !(function (e) {
                ...
                var n = e.dropdown.querySelector(
                  '.js-select__item[data-index="' +
      ...
      if (
        ((n =
          ...
          ("true" == t.trigger.getAttribute("aria-expanded")
            ? "false"
            : "true")),
        t.trigger.setAttribute("aria-expanded", n),
        "true" == n)
      ) {
        var o =
          (s = t).dropdown.querySelector('[aria-selected="true"]') ||
          s.dropdown.getElementsByClassName("js-select__item")[0];
        Util.moveFocus(o),
    ...
    function i(e) {
      ...
      e.dropdown.setAttribute(
        "style",
        "max-height: " + s + "px; width: " + t.width + "px;"
      );
    }
    function s(e, t, n) {
      n.preventDefault();
      var s = Util.getIndexInArray(e.customOptions, document.activeElement);
      (s = "next" == t ? s + 1 : s - 1) < 0 && (s = e.customOptions.length - 1),
        s >= e.customOptions.length && (s = 0),
        Util.moveFocus(e.customOptions[s]);
    }
    function r(e) {
    ...
    function l(e, t) {
      for (var n = "", s = 0; s < t.length; s++) {
        var o = t[s].hasAttribute("selected")
          ? ' aria-selected="true"'
          : ' aria-selected="false"';
        (n =
          n +
  ...
  (function () {
    function n(e) {
      var t = getComputedStyle(e, ":before")
  ...
  (function () {
    var e = function (e) {
      (this.element = e),
        (this.triggers = document.querySelector(
          ".style-guide__header-control"
        )),
        (this.list = this.element.getElementsByClassName(
          "style-guide__nav-list"
        )[0]),
        (this.anchors = this.list.querySelectorAll('a[href^="#"]')),
        (this.indicator = this.element.getElementsByClassName(
          "style-guide__nav-indicator"
        )[0]),
        (this.sections = (function (e) {
          for (var t = [], n = 0; n < e.anchors.length; n++) {
            var s = document.getElementById(
              e.anchors[n].getAttribute("href").replace("#", "")
            );
            s && t.push(s);
          }
          return t;
        ...
        (function (t) {
          (s = t),
                ...
                s.element.classList.contains(s.showClass)
                  ...
                  : ((n = s),
                    ...
                    n.element.addEventListener("transitionend", function e(t) {
                      n.element.removeEventListener("transitionend", e),
                        n.firstFocusable.focus();
                    }));
              }),
              window.addEventListener("keyup", function (e) {
                ((e.keyCode && 27 == e.keyCode) ||
                  ...
                  ((e.keyCode && 9 == e.keyCode) ||
                    ...
                    (document.activeElement.closest(".style-guide__header") ||
                      r(s, e, !0));
              })),
            (i = t),
            l(i, i.anchors[0]),
            i.list.addEventListener("click", function (e) {
              ...
              o &&
                !o.classList.contains("style-guide__nav-link--current") &&
                (i.clickScrolling
                  ? e.preventDefault()
                  : ((i.clickScrolling = !0),
                    l(i, o),
          ...
          t.select.addEventListener("change", function (e) {
            t.main.setAttribute(
              "data-theme",
              t.select.options[t.select.selectedIndex].value
            );
          });
        })(this);
    };
    function r(e, t, n) {
      e.element.classList.contains(e.showClass) &&
        (t && t.preventDefault(),
        e.element.classList.remove(e.showClass),
        e.selectedTrigger &&
          (e.selectedTrigger.setAttribute("aria-expanded", "false"),
          n || e.selectedTrigger.focus(),
          (e.selectedTrigger = !1)));
    }
    function l(e, t) {
      if (a) {
        for (var n = 0; n < e.anchors.length; n++)
          e.anchors[n].classList.remove("style-guide__nav-link--current");
        var s;
        t &&
          (t.classList.add("style-guide__nav-link--current"),
          (s = t),
          (e.indicator.style.transform =
            "translateX(" +
            s.offsetLeft +
            "px) scaleX(" +
            s.offsetWidth +
    ...
    function o(s) {
      s.intervalID ||
        (s.intervalID = setTimeout(function () {
          for (
            var e = window.innerHeight / 2, t = -1, n = 0;
            n < s.sections.length;
            n++
          ) {
