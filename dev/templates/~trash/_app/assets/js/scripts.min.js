...
(Util.hasClass = function (e, t) {
  ...
  (Util.removeClass = function (e, t) {
    var n,
      a = t.split(" ");
    e.classList ? e.classList.remove(a[0]) : Util.hasClass(e, a[0]) && ((n = new RegExp("(\\s|^)" + a[0] + "(\\s|$)")), (e.className = e.className.replace(n, " "))), 1 < a.length && Util.removeClass(e, a.slice(1).join(" "));
  }),
  ...
  (Util.getChildrenByClassName = function (e, t) {
    e.children;
    for (var n = [], a = 0; a < e.children.length; a++) Util.hasClass(e.children[a], t) && n.push(e.children[a]);
    return n;
  }),
  (Util.is = function (e, t) {
    if (t.nodeType) return e === t;
    for (var n = "string" == typeof t ? document.querySelectorAll(t) : t, a = n.length; a--; ) if (n[a] === e) return !0;
    return !1;
  }),
  (Util.setHeight = function (a, e, s, i, r) {
    var o = e - a,
      l = null,
      d = function (e) {
        var t = e - (l = l || e),
          n = parseInt((t / i) * o + a);
        (s.style.height = n + "px"), t < i ? window.requestAnimationFrame(d) : r();
      };
    (s.style.height = a + "px"), window.requestAnimationFrame(d);
  }),
  (Util.scrollTo = function (a, s, i, e) {
    var r = e || window,
      o = r.scrollTop || document.documentElement.scrollTop,
      l = null;
    e || (o = window.scrollY || document.documentElement.scrollTop);
    var d = function (e) {
      var t = e - (l = l || e);
      s < t && (t = s);
      var n = Math.easeInOutQuad(t, o, a - o, s);
      r.scrollTo(0, n), t < s ? window.requestAnimationFrame(d) : i && i();
    };
  ...
  (Util.extend = function () {
    var n = {},
      ...
      e = 0,
      t = arguments.length;
    "[object Boolean]" === Object.prototype.toString.call(arguments[0]) && ((a = arguments[0]), e++);
    for (; e < t; e++) {
      !(function (e) {
        for (var t in e) Object.prototype.hasOwnProperty.call(e, t) && (a && "[object Object]" === Object.prototype.toString.call(e[t]) ? (n[t] = extend(!0, n[t], e[t])) : (n[t] = e[t]));
      })(arguments[e]);
    }
    return n;
  }),
  ...
  (Math.easeInQuart = function (e, t, n, a) {
    return n * (e /= a) * e * e * e + t;
  }),
  (Math.easeOutQuart = function (e, t, n, a) {
    return (e /= a), -n * (--e * e * e * e - 1) + t;
  }),
  (Math.easeInOutQuart = function (e, t, n, a) {
    return (e /= a / 2) < 1 ? (n / 2) * e * e * e * e + t : (-n / 2) * ((e -= 2) * e * e * e - 2) + t;
  }),
  (Math.easeOutElastic = function (e, t, n, a) {
    var s = 1.70158,
      i = 0.7 * a,
      r = n;
    return 0 == e ? t : 1 == (e /= a) ? t + n : ((i = i || 0.3 * a), (s = r < Math.abs(n) ? ((r = n), i / 4) : (i / (2 * Math.PI)) * Math.asin(n / r)), r * Math.pow(2, -10 * e) * Math.sin(((e * a - s) * (2 * Math.PI)) / i) + n + t);
  }),
  (function () {
    var a = document.getElementsByClassName("js-tab-focus");
    function t() {
      0 < a.length && (s(!1), window.addEventListener("keydown", n)), window.removeEventListener("mousedown", t);
    }
    function n(e) {
      9 === e.keyCode && (s(!0), window.removeEventListener("keydown", n), window.addEventListener("mousedown", t));
    }
    function s(e) {
      for (var t = e ? "" : "none", n = 0; n < a.length; n++) a[n].style.setProperty("outline", t);
    }
  ...
  (function () {
    function e(e) {
      ...
      (this.element = e),
        ...
        (n = this),
        h && n.element.removeAttribute("data-animation"),
        ...
        (function (i) {
          (function (e) {
            ...
            i.changeColor && a(i, i.value);
          i.animate && i.canAnimate
            ? (function (e) {
                u(e, 0),
                  new IntersectionObserver(
                    function (e, t) {
                      ...
                      0 < e[0].intersectionRatio.toFixed(1) &&
                        ...
                        r(this, 0, this.value, this.animationDuration, function () {
            ...
            : u(i, i.value);
          setTimeout(function () {
            Util.addClass(i.element, "c-progress-bar--init");
          }, 30),
            i.element.addEventListener("updateProgress", function (e) {
              i.animationId && window.cancelAnimationFrame(i.animationId);
              var t,
                n = e.detail.value,
                a = e.detail.duration ? e.detail.duration : i.animationDuration,
                s = ((t = i), 100 - Math.round((parseFloat(t.fill.getAttribute("stroke-dashoffset")) / t.fillLength) * 100));
              r(i, s, n, a, function () {
                o(i, "progressCompleted", i.value + "%"), 0 < i.ariaLabel.length && (i.ariaLabel[0].textContent = n + "%");
              });
            });
        })(this),
        (this.animationId = !1);
    ...
    function u(e, t) {
      ...
      e.fill.setAttribute("stroke-dashoffset", n), 0 < e.label.length && (e.label[0].textContent = t), e.changeColor && a(e, t);
    }
    function r(a, s, i, r, o) {
      var l = i - s,
        d = null,
        c = function (e) {
          var t = e - (d = d || e),
            n = parseInt((t / r) * l + s);
          0 < l && i < n && (n = i), l < 0 && n < i && (n = i), r <= t && (n = i), u(a, n), t < r ? (a.animationId = window.requestAnimationFrame(c)) : ((a.animationId = !1), o());
        };
      window.requestAnimationFrame && !h ? (a.animationId = window.requestAnimationFrame(c)) : (u(a, i), o());
    }
    function a(e, t) {
      for (var n, a, s = "c-progress-bar--fill-color-" + e.colorThresholds.length, i = e.colorThresholds.length; 0 < i; i--) !isNaN(e.colorThresholds[i - 1]) && t <= e.colorThresholds[i - 1] && (s = "c-progress-bar--fill-color-" + i);
      (a = (n = e).element.className.split(" ").filter(function (e) {
        return 0 !== e.lastIndexOf("c-progress-bar--fill-color-", 0);
      })),
        (n.element.className = a.join(" ").trim()),
        Util.addClass(e.element, s);
    }
    function o(e, t, n) {
  ...
  (function () {
          ...
          e.element.insertAdjacentHTML(
            ...
            (function (e) {
              var t = e.element.getAttribute("data-trigger-class") ? " " + e.element.getAttribute("data-trigger-class") : "",
                ...
                a = '<button type="button" class="js-select__button select__button' + t + '" aria-label="' + n + '" aria-expanded="false" aria-controls="' + e.selectId + '-dropdown"><span aria-hidden="true" class="js-select__label select__label">' + e.selectedOption + "</span>";
              {
                var s;
                0 < e.arrowIcon.length && e.arrowIcon[0].outerHTML && ((s = e.arrowIcon[0].cloneNode(!0)), Util.removeClass(s, "select__icon"), (a += s.outerHTML));
              }
              return a + "</button>";
            })(e) +
              (function (e) {
                ...
                if (
                  ...
                  for (var n = 0; n < e.optGroups.length; n++) {
                    var a = e.optGroups[n].getElementsByTagName("option"),
                      s = '<li><span class="select__item select__item--optgroup">' + e.optGroups[n].getAttribute("label") + "</span></li>";
                    t = t + '<ul class="select__list" role="listbox">' + s + r(e, a) + "</ul>";
                  }
          ...
          t.dropdown.addEventListener("keydown", function (e) {
            ...
            t.element.addEventListener("select-updated", function (e) {
              !(function (e) {
                ...
                n.setAttribute("aria-selected", "true"), (e.trigger.getElementsByClassName("js-select__label")[0].textContent = n.textContent), e.trigger.setAttribute("aria-expanded", "false"), a(e);
              })(t);
            });
        })(this);
    }
    function s(t, e) {
      var n,
        a,
        s = e || ("true" == t.trigger.getAttribute("aria-expanded") ? "false" : "true");
      t.trigger.setAttribute("aria-expanded", s),
        "true" == s &&
          ((n = (a = t).dropdown.querySelector('[aria-selected="true"]') || a.dropdown.getElementsByClassName("js-select__item")[0]),
          Util.moveFocus(n),
    ...
    function i(e) {
      ...
      var a = n ? t.top - 20 : window.innerHeight - t.bottom - 20;
      e.dropdown.setAttribute("style", "max-height: " + a + "px; width: " + t.width + "px;");
    }
    function n(e, t, n) {
      n.preventDefault();
      var a = Util.getIndexInArray(e.customOptions, document.activeElement);
      (a = "next" == t ? a + 1 : a - 1) < 0 && (a = e.customOptions.length - 1), a >= e.customOptions.length && (a = 0), Util.moveFocus(e.customOptions[a]);
    }
    function a(e) {
    ...
    function r(e, t) {
      for (var n = "", a = 0; a < t.length; a++) {
        var s = t[a].hasAttribute("selected") ? ' aria-selected="true"' : ' aria-selected="false"',
          n = n + '<li><button type="button" class="reset js-select__item select__item select__item--option" role="option" data-value="' + t[a].value + '" ' + s + ' data-index="' + e.optionIndex + '">' + t[a].text + "</button></li>";
    ...
    if (0 < t.length) {
      for (var o = [], l = 0; l < t.length; l++) o.push(new e(t[l]));
      window.addEventListener("keyup", function (e) {
        ((e.keyCode && 27 == e.keyCode) || (e.key && "escape" == e.key.toLowerCase())) &&
          o.forEach(function (e) {
            var t;
            (t = e), document.activeElement.closest(".js-select") && t.trigger.focus(), s(e, "false");
          });
      }),
        window.addEventListener("click", function (a) {
          o.forEach(function (e) {
            var t, n;
            (t = e), (n = a.target), t.element.contains(n) || s(t, "false");
          });
        });
    }
  })(),
  (function () {
    var n = function (e) {
      ...
      (this.options = Util.extend(n.defaults, e)),
        ...
        (function (e) {
          b(e), 0 < e.dateValueEl.length && (s(e), y(e));
        ...
        (function (a) {
          a.input.addEventListener("focus", function (e) {
            d(a, !0);
          }),
            a.trigger &&
              a.trigger.addEventListener("click", function (e) {
                e.preventDefault(), (a.pickerVisible = !1), d(a), a.trigger.setAttribute("aria-expanded", "true");
              });
          a.body.addEventListener("click", function (e) {
            e.preventDefault();
            var t,
              n = e.target.closest("button");
            n && ((a.dateSelected = !0), (a.selectedDay = n.innerText), (a.selectedMonth = a.currentMonth), (a.selectedYear = a.currentYear), ((t = a).input.value = p(t)), a.input.focus(), b(a), y(a));
          }),
            a.navigation.addEventListener("click", function (e) {
              e.preventDefault();
              var t = e.target.closest(".js-date-picker__month-nav-btn");
              t && (Util.hasClass(t, "js-date-picker__month-nav-btn--prev") ? o : r)(a, !0);
            }),
            window.addEventListener("keydown", function (e) {
              ((e.keyCode && 27 == e.keyCode) || (e.key && "escape" == e.key.toLowerCase())) && (document.activeElement.closest(".js-date-picker") ? a.input.focus() : l(a));
            }),
            window.addEventListener("click", function (e) {
              e.target.closest(".js-date-picker") || e.target.closest(".js-date-input") || !a.pickerVisible || l(a);
            }),
            a.body.addEventListener("keydown", function (e) {
              var t = a.currentDay;
              (e.keyCode && 40 == e.keyCode) || (e.key && "arrowdown" == e.key.toLowerCase())
                ...
                ? (e.preventDefault(), f((t = t + 6 - g(a.currentYear, a.currentMonth, t)), a))
                : (e.keyCode && 36 == e.keyCode) || (e.key && "home" == e.key.toLowerCase())
                ? (e.preventDefault(), f((t -= g(a.currentYear, a.currentMonth, t)), a))
                : (e.keyCode && 34 == e.keyCode) || (e.key && "pagedown" == e.key.toLowerCase())
                ? (e.preventDefault(), r(a))
                : ((e.keyCode && 33 == e.keyCode) || (e.key && "pageup" == e.key.toLowerCase())) && (e.preventDefault(), o(a));
            }),
            a.datePicker.addEventListener("keydown", function (e) {
            ...
            a.input.addEventListener("keydown", function (e) {
              (e.keyCode && 13 == e.keyCode) || (e.key && "enter" == e.key.toLowerCase()) ? (s(a), b(a), y(a), l(a)) : ((e.keyCode && 40 == e.keyCode) || (e.key && "arrowdown" == e.key.toLowerCase() && a.pickerVisible)) && a.body.querySelector('button[tabindex="0"]').focus();
            });
        })(this);
    };
    function c(e) {
      return e ? ((t = parseInt(e.split("-")[2])), isNaN(t) ? c(!1) : t) : new Date().getDate();
      var t;
    }
    function u(e) {
      return e ? ((t = parseInt(e.split("-")[1]) - 1), isNaN(t) ? u(!1) : t) : new Date().getMonth();
      var t;
    }
    function h(e) {
    ...
    function r(e, t) {
      (e.currentYear = 11 === e.currentMonth ? e.currentYear + 1 : e.currentYear), (e.currentMonth = (e.currentMonth + 1) % 12), (e.currentDay = a(e)), i(e, t), (e.srLiveReagion.textContent = e.options.months[e.currentMonth] + " " + e.currentYear);
    }
    function o(e, t) {
      (e.currentYear = 0 === e.currentMonth ? e.currentYear - 1 : e.currentYear), (e.currentMonth = 0 === e.currentMonth ? 11 : e.currentMonth - 1), (e.currentDay = a(e)), i(e, t), (e.srLiveReagion.textContent = e.options.months[e.currentMonth] + " " + e.currentYear);
    }
    function a(e) {
    ...
    function s(e) {
      var t,
        ...
        s = !1,
        i = e.input.value;
      (e.dateSelected = !1), "" != i && ((t = (a = (n = e).input.value.split(n.options.dateSeparator))[n.dateIndexes[2]] + "-" + a[n.dateIndexes[1]] + "-" + a[n.dateIndexes[0]]), (e.dateSelected = !0), (s = t)), (e.currentDay = c(s)), (e.currentMonth = u(s)), (e.currentYear = h(s)), (e.selectedDay = !!e.dateSelected && e.currentDay), (e.selectedMonth = !!e.dateSelected && e.currentMonth), (e.selectedYear = !!e.dateSelected && e.currentYear);
    }
    function i(e, t) {
      (e.datePicker.style.left = ""), (e.datePicker.style.right = "");
      ...
      for (var a, s = 1, i = "", r = 0; r < 6; r++)
        for (var o = 0; o < 7; o++)
          if (0 === r && o < n) i += "<li></li>";
            ...
            var l = "",
              d = "-1";
            s === e.currentDay && (d = "0"), e.dateSelected || u() != e.currentMonth || h() != e.currentYear || s != c() || (l += " date-picker__date--today"), e.dateSelected && s === e.selectedDay && e.currentYear === e.selectedYear && e.currentMonth === e.selectedMonth && (l += "  date-picker__date--selected"), (i = i + '<li><button class="date-picker__date' + l + '" tabindex="' + d + '">' + s + "</button></li>"), s++;
          }
      (e.body.innerHTML = i), e.pickerVisible || Util.addClass(e.datePicker, "date-picker--is-visible"), (e.pickerVisible = !0), t || e.body.querySelector('button[tabindex="0"]').focus(), x(e), (a = e).datePicker.getBoundingClientRect().right > window.innerWidth && ((a.datePicker.style.left = "auto"), (a.datePicker.style.right = "0px"));
    }
    function l(e) {
    ...
    function d(e, t) {
      e.pickerVisible ? l(e) : (s(e), i(e, t));
    }
    function g(e, t, n) {
      var a = new Date(e, t, n).getDay() - 1;
      return a < 0 && (a = 6), a;
    }
    function p(e) {
      var t = [];
    ...
    function f(e, t) {
      ...
      if (n < e) (t.currentDay = e - n), r(t, !1);
      else if (e < 1) {
        var a = 0 == t.currentMonth ? 11 : t.currentMonth - 1;
        (t.currentDay = m(t.currentYear, a) + e), o(t, !1);
      } else {
        (t.currentDay = e), t.body.querySelector('button[tabindex="0"]').setAttribute("tabindex", "-1");
        for (var s = t.body.getElementsByTagName("button"), i = 0; i < s.length; i++)
          if (s[i].textContent == t.currentDay) {
            s[i].setAttribute("tabindex", "0"), s[i].focus();
            break;
          }
        x(t);
      }
    ...
    var e,
      t,
      w = document.getElementsByClassName("js-date-input"),
    ...
    if (0 < w.length)
      for (var _ = 0; _ < w.length; _++)
        (e = _),
          ...
          C
            ? ((t = { element: w[e] }),
              w[e].getAttribute("data-date-format") && (t.dateFormat = w[e].getAttribute("data-date-format")),
              w[e].getAttribute("data-date-separator") && (t.dateSeparator = w[e].getAttribute("data-date-separator")),
              w[e].getAttribute("data-months") &&
                (t.months = w[e]
  ...
  (window.menuAim = function (e) {
    !(function (e) {
      ...
      function n() {
        i && clearTimeout(i), b.enter(this), o(this);
      }
      function a() {
        b.exit(this);
      }
      ...
      var p = null,
        ...
        l = function () {
          ...
          var e,
            t = {
              top: (e = y.getBoundingClientRect()).top + window.pageYOffset,
              left: e.left + window.pageXOffset,
            },
            n = { x: t.left, y: t.top - b.tolerance },
            a = { x: t.left + y.offsetWidth, y: n.y },
            s = { x: t.left, y: t.top + y.offsetHeight + b.tolerance },
            i = { x: t.left + y.offsetWidth, y: s.y },
            r = v[v.length - 1],
            o = v[0];
          if (!r) return 0;
          if ((o = o || r).x < t.left || o.x > i.x || o.y < t.top || o.y > i.y) return 0;
          if (f && r.x == f.x && r.y == f.y) return 0;
          function l(e, t) {
            return (t.y - e.y) / (t.x - e.x);
          }
          var d = a,
            c = i;
          "left" == b.submenuDirection ? ((d = s), (c = n)) : "below" == b.submenuDirection ? ((d = i), (c = s)) : "above" == b.submenuDirection && ((d = n), (c = a));
          var u = l(r, d),
            h = l(r, c),
            m = l(o, d),
            g = l(o, c);
          return u < m && g < h ? ((f = r), 300) : ((f = null), 0);
        };
      y.addEventListener("mouseleave", function () {
        i && clearTimeout(i), b.exitMenu(this) && (p && b.deactivate(p), (p = null));
      });
      var d = b.rows ? b.rows : y.children;
      if (0 < d.length)
        for (var c = 0; c < d.length; c++)
          !(function (e) {
            d[e].addEventListener("mouseenter", n), d[e].addEventListener("mouseleave", a), d[e].addEventListener("click", s);
          })(c);
  ...
  (function () {
          ...
          if (t.triggers)
            for (var e = 0; e < t.triggers.length; e++)
              t.triggers[e].addEventListener("click", function (e) {
                e.preventDefault(), (t.selectedTrigger = e.target), n(t), s(t);
              });
          t.element.addEventListener("openDialog", function (e) {
            e.detail && (self.selectedTrigger = e.detail), n(t), s(t);
          });
        })(this);
    }
    function n(n) {
    ...
    function a(e) {
      var t;
      Util.removeClass(e.element, e.showClass), (e.firstFocusable = null), (e.lastFocusable = null), e.selectedTrigger && e.selectedTrigger.focus(), (t = e).element.removeEventListener("keydown", i.bind(t)), t.element.removeEventListener("click", i.bind(t)), r(e, "dialogIsClose");
    }
    function s(e) {
  ...
  (function () {
    ...
    (n.prototype.initMenu = function () {
      for (var e = 0; e < this.trigger.length; e++)
        Util.setAttributes(this.trigger[e], {
          "aria-expanded": "false",
          "aria-haspopup": "true",
        });
      ...
      (n.prototype.positionMenu = function (e, t) {
        var n = this.selectedTrigger.getBoundingClientRect(),
          a = window.innerHeight - n.bottom < n.top,
          s = n.left,
          i = window.innerWidth - n.right,
          r = window.innerWidth < n.left + this.element.offsetWidth,
          o = r ? "right: " + i + "px;" : "left: " + s + "px;",
          l = a ? "bottom: " + (window.innerHeight - n.top) + "px;" : "top: " + n.bottom + "px;";
        r && i + this.element.offsetWidth > window.innerWidth && (o = "left: " + parseInt((window.innerWidth - this.element.offsetWidth) / 2) + "px;");
        var d = a ? n.top - 20 : window.innerHeight - n.bottom - 20;
        this.element.setAttribute("style", o + l + "max-height:" + Math.floor(d) + "px;");
      }),
      (n.prototype.navigateItems = function (e, t) {
        e.preventDefault();
        var n = Util.getIndexInArray(this.menuItems, e.target),
          a = "next" == t ? n + 1 : n - 1;
        a < 0 && (a = this.menuItems.length - 1), a > this.menuItems.length - 1 && (a = 0), Util.moveFocus(this.menuItems[a]);
      }),
      ...
      (window.Menu = n);
    var a = document.getElementsByClassName("js-menu");
    if (0 < a.length) {
      for (var s = [], i = [], e = 0; e < a.length; e++)
        !(function (e) {
          s.push(new n(a[e]));
          var t = a[e].getAttribute("data-scrollable-element");
      ...
      for (var t = 0; t < i.length; t++) {
        var r = document.querySelector(i[t]);
        r &&
  ...
  (function () {
    ...
    (e.prototype.initModal = function () {
      ...
      (e.prototype.getFirstFocusable = function () {
        if (this.modalFocus && Element.prototype.matches)
          if (this.modalFocus.matches(a)) this.moveFocusEl = this.modalFocus;
          else {
            this.moveFocusEl = !1;
            for (var e = this.modalFocus.querySelectorAll(a), t = 0; t < e.length; t++)
              if (n(e[t])) {
    ...
    var t = document.getElementsByClassName("js-modal"),
      a = '[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex]:not([tabindex="-1"]), [contenteditable], audio[controls], video[controls], summary';
    if (0 < t.length) {
      for (var s = [], i = 0; i < t.length; i++) s.push(new e(t[i]));
      window.addEventListener("keydown", function (e) {
        if ((e.keyCode && 27 == e.keyCode) || (e.key && "escape" == e.key.toLowerCase())) for (var t = 0; t < s.length; t++) s[t].closeModal();
      });
    }
  })(),
  (function () {
      ...
      (this.element = e),
        ...
        (function (e) {
          ...
          for (var t = "", n = 0; n < e.percentages.length; n++) {
            var a = e.percentages[n].getAttribute("data-pct-bar-bg"),
              s = e.percentages[n].getAttribute("data-pct-bar-style"),
              i = e.percentages[n].textContent;
            t = t + '<div class="pct-bar__fill js-pct-bar__fill ' + (a = a || "") + '" style="flex-basis: ' + i + ";" + (s = s || "") + '"></div>';
          }
          e.bar[0].innerHTML = t;
        })(this);
    }
  ...
  (function () {
    var n = function (e) {
      ...
      (this.options = Util.extend(n.defaults, e)),
        ...
        a((t = this)),
        (function (e) {
          if (!e.options.animate || e.chartLoaded || E || !_) return;
          new IntersectionObserver(
            function (e, t) {
              e[0].isIntersecting &&
                ((this.chartLoaded = !0),
                (function (o) {
                  var l = null,
                    ...
                    c = function (t, e) {
                      var n = e - (l = l || e);
                      d < n && (n = d);
                      var a = o.percentageStart[t],
                        s = a + o.percentageDelta[t] * (n / d),
                        i = o.element.getElementsByClassName("js-pie-chart__data-path--" + (t + 1))[0],
                        r = u(o, a, s);
                      i.setAttribute("d", r),
                        n < d
        ...
        (function (t) {
          function e() {
            var e;
            ((e = t).hovering = !1), e.eventIds && e.eventIds.hover && (e.chartArea.removeEventListener("mouseenter", e.eventIds.hover), e.chartArea.removeEventListener("mousedown", e.eventIds.hover), e.chartArea.removeEventListener("mousemove", e.eventIds.hover), e.chartArea.removeEventListener("mouseleave", e.eventIds.hover)), t.svg.remove(), a(t), s(t);
          }
    ...
    function a(e) {
      ...
      ((t = e).height = t.chartArea.clientHeight),
        ...
        (a = '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="' + (n = e).width + '" height="' + n.height + '" class="pie-chart__svg js-pie-chart__svg"></svg>'),
        (n.chartArea.innerHTML = n.chartArea.innerHTML + a),
        ...
        (function (e) {
          ...
          for (var n = 0; n < e.dataValues.length; n++) {
            ...
            Util.setAttributes(a, {
              d: (function (e, t) {
                var n = e.percentageTot * e.percentageReset * 3.6,
                  a = parseFloat(e.dataValues[t].textContent);
                e.percentageStart.push(n), e.percentageDelta.push(a * e.percentageReset * 3.6), (e.percentageTot = e.percentageTot + a);
                var s = e.percentageTot * e.percentageReset * 3.6;
                return u(e, n, s);
              })(e, n),
            ...
            var s = e.dataValues[n].getAttribute("data-pie-chart-style");
            s && a.setAttribute("style", s), t.appendChild(a);
          }
    ...
    function u(e, t, n) {
      return (
        !e.chartLoaded && e.options.animate && _ && !E && (n = t),
        "pie" == e.options.type
          ? ((g = e.width / 2), (p = e.width / 2), (v = e.width / 2), (f = t), (y = C(g, p, v, (b = n))), (x = C(g, p, v, f)), (w = b - f <= 180 ? "0" : "1"), ["M", y.x, y.y, "A", v, v, 0, w, 0, x.x, x.y, "L", g, p, "L", y.x, y.y].join(" "))
          : ((a = e.width / 2), (s = e.width / 2), (i = e.width / 2), (r = e.donutSize), (o = t), (d = C(a, s, i - r, (l = n))), (c = C(a, s, i, l)), (u = C(a, s, i, o)), (h = C(a, s, i - r, o)), (m = l - o <= 180 ? "0" : "1"), ["M", d.x, d.y, "L", c.x, c.y, "A", i, i, 0, m, 0, u.x, u.y, "L", h.x, h.y, "A", i - r, i - r, 0, m, 1, d.x, d.y].join(" "))
      );
      var a, s, i, r, o, l, d, c, u, h, m, g, p, v, f, b, y, x, w;
    }
    function s(e) {
      e.tooltip.length < 1 ||
    ...
    function i(e, t) {
      var n, a, s, i, r, o;
      e.hovering ||
        (!(e.hovering = !0) !== (n = "path" == (a = t).target.tagName.toLowerCase() && parseInt(a.target.getAttribute("data-index"))) &&
          n !== e.selectedIndex &&
          ((e.selectedIndex = n), ((o = e).tooltip[0].textContent = o.dataValues[o.selectedIndex].textContent), (i = "donut" == (s = e).options.type ? (s.width - s.donutSize) / 2 : s.width / 4), (r = C(s.width / 2, s.width / 2, i, s.percentageStart[s.selectedIndex] + s.percentageDelta[s.selectedIndex] / 2)), s.tooltip[0].setAttribute("style", "left: " + r.x + "px; top: " + r.y + "px"), Util.removeClass(e.tooltip[0], "is-hidden")),
        (e.hovering = !1));
    }
    function C(e, t, n, a) {
      var s = ((a - 90) * Math.PI) / 180;
      return { x: e + n * Math.cos(s), y: t + n * Math.sin(s) };
    }
    ...
    var e,
      ...
      _ = "IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype,
      E = Util.osHasReducedMotion();
    if (0 < o.length) for (var l = 0; l < o.length; l++) (r = t = void 0), (t = o[(e = l)].getAttribute("data-pie-chart-type") ? o[e].getAttribute("data-pie-chart-type") : "pie"), (r = !(!o[e].getAttribute("data-pie-chart-animation") || "on" != o[e].getAttribute("data-pie-chart-animation"))), new n({ element: o[e], type: t, animate: r });
  })(),
  (function () {
    function n(e) {
      var t;
      (this.element = e),
        ...
        (function (n) {
          for (var e = 0; e < n.trigger.length; e++)
            !(function (t) {
              n.trigger[t].addEventListener("click", function (e) {
                e.preventDefault(), Util.hasClass(n.element, n.popoverVisibleClass) && n.selectedTrigger != n.trigger[t] && a(n, !1, !1), (n.selectedTrigger = n.trigger[t]), a(n, !Util.hasClass(n.element, n.popoverVisibleClass), !0);
              });
            })(e);
      ...
      Util.toggleClass(t.element, t.popoverVisibleClass, e),
        (t.popoverIsOpen = e)
          ? (t.selectedTrigger.setAttribute("aria-expanded", "true"),
            (s = (a = t).element.querySelectorAll(o)),
            (function (e, t) {
            ...
            (function (e) {
              ...
              var t = e.positionTarget ? e.positionTarget.getBoundingClientRect() : e.selectedTrigger.getBoundingClientRect(),
                ...
                i = window.innerWidth < t.left + e.element.offsetWidth,
                r = i ? "right: " + s + "px;" : "left: " + a + "px;",
                o = n ? "bottom: " + (window.innerHeight - t.top) + "px;" : "top: " + t.bottom + "px;";
              i && s + e.element.offsetWidth > window.innerWidth && (r = "left: " + parseInt((window.innerWidth - e.element.offsetWidth) / 2) + "px;");
              var l = n ? t.top - e.viewportGap : window.innerHeight - t.bottom - e.viewportGap,
                d = e.element.getAttribute("style");
              d = d || "";
              e.element.setAttribute("style", d + r + o + "max-height:" + Math.floor(l) + "px;");
            })(t),
    ...
    (n.prototype.togglePopover = function (e, t) {
      ...
      (n.prototype.checkPopoverClick = function (e) {
        !(function (e, t) {
          ...
          e.element.contains(t) || t.closest('[aria-controls="' + e.elementId + '"]') || a(e, !1);
        })(this, e);
      }),
  ...
  (function () {
    function e(e) {
      ...
      (this.element = e),
        ...
        (this.value = i(this)),
        (t = this),
        h && t.element.removeAttribute("data-animation"),
        (this.animate = this.element.hasAttribute("data-animation") && "on" == this.element.getAttribute("data-animation")),
        (this.animationDuration = this.element.hasAttribute("data-duration") ? this.element.getAttribute("data-duration") : 1e3),
        (this.canAnimate = "IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype),
        ...
        (function (s) {
          ...
          setTimeout(function () {
            Util.addClass(s.element, "progress-bar--init");
          }, 30),
            s.element.addEventListener("updateProgress", function (e) {
              s.animationId && window.cancelAnimationFrame(s.animationId);
              var t = e.detail.value,
                n = e.detail.duration ? e.detail.duration : s.animationDuration,
                a = i(s);
              r(s, a, t, n, function () {
                o(s, "progressCompleted", s.value + "%"), 0 < s.ariaLabel.length && (s.ariaLabel[0].textContent = t + "%");
              });
            });
        })(this),
        (this.animationId = !1);
    ...
    function n(e, t) {
      for (var n, a, s = "progress-bar--fill-color-" + e.colorThresholds.length, i = e.colorThresholds.length; 0 < i; i--) !isNaN(e.colorThresholds[i - 1]) && t <= e.colorThresholds[i - 1] && (s = "progress-bar--fill-color-" + i);
      (a = (n = e).element.className.split(" ").filter(function (e) {
  ...
  (function () {
          ...
          new IntersectionObserver(
            function (e, t) {
              e[0].isIntersecting &&
                ...
                (function (i) {
                  var r = null,
                    o = i.element.getElementsByClassName("js-radial-bar__circle__fill"),
                    l = function (e) {
                      var t = e - (r = r || e);
                      600 < t && (t = 600);
                      for (var n = 0; n < i.percentages.length; n++) {
                        var a = Math.easeOutQuart(t, 0, i.chartDashStroke[n][0], 600),
                          s = i.chartDashStroke[n][2] - a;
                        o[n].setAttribute("stroke-dasharray", a + " " + s);
                      }
                      t < 600 && window.requestAnimationFrame(l);
                    };
    ...
    function a(e) {
      ...
      ((t = e).height = t.chartArea.clientHeight),
        ...
        (a = '<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="' + (n = e).width + '" height="' + n.height + '" class="radial-bar__svg js-radial-bar__svg"></svg>'),
        (n.chartArea.innerHTML = n.chartArea.innerHTML + a),
        ...
        (function (e) {
          for (var t = 0; t < e.percentages.length; t++) {
            var n = document.createElementNS("http://www.w3.org/2000/svg", "g"),
              ...
              i = e.percentages[t].getAttribute("data-radial-bar-color");
            i = i || "";
            var r = e.height / 2 - (e.circleStroke + e.circleGap) * t - e.circleStroke,
              o = 2 * Math.PI * r,
              l = parseInt(e.percentages[t].textContent);
            e.chartDashStroke.push([(o * l) / 100, (o * (100 - l)) / 100, o]),
            ...
            !e.chartLoaded && e.options.animate && c && !u && (d = "0 " + 2 * o),
              Util.setAttributes(a, {
                cx: e.height / 2,
                cy: e.width / 2,
                r: r,
                class: "radial-bar__circle radial-bar__circle__fill js-radial-bar__circle__fill " + i,
                "stroke-dasharray": d,
                "stroke-dashoffset": o / 4,
                "data-index": t,
              }),
              n.setAttribute("class", "radial-bar__group"),
              n.appendChild(s),
              n.appendChild(a),
              e.svg.appendChild(n);
          }
    ...
    function i(e, t) {
      var n, a, s;
      e.hovering || (!(e.hovering = !0) !== (n = "circle" == (a = t).target.tagName.toLowerCase() && parseInt(a.target.getAttribute("data-index"))) && n !== e.selectedIndex ? ((e.selectedIndex = n), ((s = e).tooltip[0].textContent = s.percentages[s.selectedIndex].textContent), Util.removeClass(e.tooltip[0], "is-hidden")) : !1 === n && r(e), (e.hovering = !1));
    }
    function r(e) {
    ...
    if (0 < o.length) for (var l = 0; l < o.length; l++) (t = void 0), (t = !(!o[(e = l)].getAttribute("data-radial-chart-animation") || "on" != o[e].getAttribute("data-radial-chart-animation"))), new n({ element: o[e], animate: t });
  })(),
  (function () {
    ...
    if (0 < e.length)
      for (var t = 0; t < e.length; t++)
        e[t].addEventListener("click", function (e) {
          var t,
            n,
            a = e.target.closest(".js-sidenav__sublist-control");
          a && ((t = a.parentElement), (n = Util.hasClass(t, "sidenav__item--expanded")), a.setAttribute("aria-expanded", !n), Util.toggleClass(t, "sidenav__item--expanded", !n));
        });
  })(),
  (function () {
    function e(e) {
      var t;
      (this.element = e), (this.delta = [!1, !1]), (this.dragging = !1), (this.intervalId = !1), (t = this).element.addEventListener("mousedown", r.bind(t)), t.element.addEventListener("touchstart", r.bind(t));
    }
    function r(e) {
      switch (e.type) {
        case "mousedown":
        case "touchstart":
          (n = e),
            ((t = this).dragging = !0),
            (function (e) {
              e.element.addEventListener("mousemove", r.bind(e)), e.element.addEventListener("touchmove", r.bind(e)), e.element.addEventListener("mouseup", r.bind(e)), e.element.addEventListener("mouseleave", r.bind(e)), e.element.addEventListener("touchend", r.bind(e));
            })(t),
            (t.delta = [parseInt(o(n).clientX), parseInt(o(n).clientY)]),
            l(t, "dragStart", t.delta, n.target);
          break;
        case "mousemove":
        case "touchmove":
          !(function (e, t) {
            ...
            window.requestAnimationFrame
              ? (e.intervalId = window.requestAnimationFrame(a.bind(e, t)))
        ...
        case "touchend":
          !(function (e, t) {
            !(function (e) {
              e.intervalId && (window.requestAnimationFrame ? window.cancelAnimationFrame(e.intervalId) : clearInterval(e.intervalId), (e.intervalId = !1)), e.element.removeEventListener("mousemove", r.bind(e)), e.element.removeEventListener("touchmove", r.bind(e)), e.element.removeEventListener("mouseup", r.bind(e)), e.element.removeEventListener("mouseleave", r.bind(e)), e.element.removeEventListener("touchend", r.bind(e));
            })(e);
            var n = parseInt(o(t).clientX),
              a = parseInt(o(t).clientY);
            {
              var s;
              e.delta && (e.delta[0] || 0 === e.delta[0]) && ((s = d(n - e.delta[0])), 30 < Math.abs(n - e.delta[0]) && l(e, s < 0 ? "swipeLeft" : "swipeRight", [n, a]), (e.delta[0] = !1));
            }
            {
              var i;
              e.delta && (e.delta[1] || 0 === e.delta[1]) && ((i = d(a - e.delta[1])), 30 < Math.abs(a - e.delta[1]) && l(e, i < 0 ? "swipeUp" : "swipeDown", [n, a]), (e.delta[1] = !1));
            }
            l(e, "dragEnd", [n, a]), (e.dragging = !1);
          })(this, e);
      }
      var t, n;
    }
    function a(e) {
      l(this, "dragging", [parseInt(o(e).clientX), parseInt(o(e).clientY)]);
    }
    function o(e) {
    ...
    function l(e, t, n, a) {
      var s = !1;
      a && (s = a);
      var i = new CustomEvent(t, { detail: { x: n[0], y: n[1], origin: s } });
  ...
  (function () {
    var t,
      e = document.getElementById("switch-light-dark");
    e &&
      ("dark" == (t = document.getElementsByTagName("html")[0]).getAttribute("data-theme") && (e.checked = !0),
      e.addEventListener("change", function (e) {
        e.target.checked ? (t.setAttribute("data-theme", "dark"), localStorage.setItem("themeSwitch", "dark")) : (t.removeAttribute("data-theme"), localStorage.removeItem("themeSwitch"));
      }));
  })(),
  (function () {
    function e(e) {
      (this.element = e),
        ...
        (function (e) {
          ...
          for (var t = 0; t < e.sections.length; t++) {
            new IntersectionObserver(n.bind(e, t), {
              rootMargin: "0px 0px " + e.animationDelta + " 0px",
            }).observe(e.sections[t]);
          }
        })(this);
    }
    function n(e, t, n) {
    ...
    if (0 < t.length) for (var i = 0; i < t.length; i++) a && !s ? new e(t[i]) : t[i].removeAttribute("data-animation");
  })(),
  (function () {
    var n = function (e) {
      var t;
      (this.options = Util.extend(n.defaults, e)),
        ...
        (function (e) {
          ...
          a(0, e.extDataX, e.extDataXInit), a(0, e.extDataY, e.extDataYInit);
        })(this);
    };
    function s(e) {
      var t, n;
      ...
      0 != e.options.datasets.length &&
                ...
                r(e),
                  ...
                  (function (e) {
                    var t = e.element.getElementsByClassName("js-chart__axis-labels--x")[0].querySelectorAll(".js-chart__axis-label"),
                      n = L(t[t.length - 1]),
                      a = e.xAxisWidth / t.length;
                    n &&
                      (function (e, t, n) {
                        if (e.xAxisLabelRotation) return;
                        for (var a = 0; a < t.length; a++) Util.setAttributes(t[a], { x: t[a].getBBox().x + n });
                      })(e, t, 0.5 * a);
                    var s = (a * e.columnWidthPerc) / 100;
                    e.options.stacked ? (e.columnWidth = s) : (e.columnWidth = (s - e.columnGap * (e.options.datasets.length - 1)) / e.options.datasets.length);
                    e.columnDelta = (a - s) / 2;
                  })(e),
                  (function (e) {
                    var t = document.createElementNS("http://www.w3.org/2000/svg", "g");
                    ...
                    for (var n = 0; n < e.options.datasets.length; n++) {
                      ...
                      a.setAttribute("class", "chart__set chart__set--" + (n + 1) + " js-chart__set"),
                        ...
                        a.appendChild(
                          (function (e, t, n) {
                            for (var a = document.createElementNS("http://www.w3.org/2000/svg", "g"), s = 0; s < t.length; s++) {
                              var i = document.createElementNS("http://www.w3.org/2000/svg", "path"),
                                r = M(e, t[s], n, s, e.datasetScaledFlat),
                                o = e.options.column && e.options.column.radius ? "round" : "square";
                              "round" == o && e.options.stacked && n < e.options.datasets.length - 1 && (o = "square");
                              var l = "round" == o ? S(e, r) : v(r);
                              Util.setAttributes(i, {
                                d: l,
                                class: "chart__data-bar chart__data-bar--" + (n + 1) + " js-chart__data-bar js-chart__data-bar--" + (n + 1),
                              }),
                                a.appendChild(i);
                            }
                            return a;
                        ...
                        t.appendChild(a),
                        a.appendChild(f(e, e.datasetScaled[n], n));
                    }
                    e.svg.appendChild(t);
                  })(e),
                  _(e);
                  ...
                  (function (e) {
                    ...
                    for (var n = 0; n < e.options.datasets.length; n++) {
                      ...
                      a.setAttribute("class", "chart__set chart__set--" + (n + 1) + " js-chart__set"),
                        ...
                        (e.datasetScaled[n] = c(e, e.datasetScaled[n])),
                        (e.datasetScaledFlat[n] = JSON.parse(JSON.stringify(e.datasetScaled[n]))),
                        "area" == e.options.type && ((e.datasetAreaScaled[n] = m(e, e.datasetScaled[n])), (e.datasetAreaScaledFlat[n] = JSON.parse(JSON.stringify(e.datasetAreaScaled[n])))),
                        !e.loaded && e.options.animate && u(e, n),
                        a.appendChild(
                          (function (e, t, n, a) {
                            var s = e.options.smooth ? g(t, !1) : v(t),
                              ...
                              r = document.createElementNS("http://www.w3.org/2000/svg", "path");
                            {
                              ...
                              Util.setAttributes(r, {
                                d: s,
                                class: "chart__data-line chart__data-line--" + (a + 1) + " js-chart__data-line--" + (a + 1),
                              }),
                                "area" == e.options.type &&
                                  ((o = e.options.smooth ? g(n, !0) : v(n)),
                                  (l = document.createElementNS("http://www.w3.org/2000/svg", "path")),
                                  Util.setAttributes(l, {
                                    d: o,
                                    class: "chart__data-fill chart__data-fill--" + (a + 1) + " js-chart__data-fill--" + (a + 1),
                                  }),
                                  i.appendChild(l));
                            }
        ...
        (function (e) {
          for (var t = '<div class="chart__sr-table sr-only">', n = 0; n < e.options.datasets.length; n++)
            t += (function (e, t) {
              ...
              for (var a = 1 < e.options.datasets[t].data[0].length, s = e.options.xAxis && e.options.xAxis.labels && 1 < e.options.xAxis.labels.length, i = 0; i < e.options.datasets[t].data.length; i++) {
                var r;
                (n += "<tr>"), (n = a ? n + '<td role="cell">' + e.options.datasets[t].data[i][0] + '</td><td role="cell">' + e.options.datasets[t].data[i][1] + "</td>" : ((r = s ? e.options.xAxis.labels[i] : i + 1), n + '<td role="cell">' + r + '</td><td role="cell">' + e.options.datasets[t].data[i] + "</td>")), (n += "</tr>");
              }
                ...
                ((function (e) {
                  "line" == e.options.type || "area" == e.options.type
                    ...
                    : "column" == e.options.type &&
                      (function (u) {
                        var h = null,
                          m = u.datasetScaledFlat,
                          g = u.datasetScaled,
                          p = function (e) {
                            var t = e - (h = h || e);
                            600 < t && (t = 600);
                            for (var n = [], a = 0; a < g.length; a++) {
                              var s = [],
                                i = u.element.getElementsByClassName("js-chart__data-bar--" + (a + 1)),
                                r = u.options.column && u.options.column.radius ? "round" : "square";
                              u.options.stacked && "round" == r && a < g.length - 1 && (r = "square");
                              for (var o = 0; o < g[a].length; o++) {
                                var l = Math.easeOutQuart(t, m[a][o][1], g[a][o][1] - m[a][o][1], 600);
                                s[o] = [g[a][o][0], l];
                                var d = M(u, s[o], a, o, n),
                                  c = "round" == r ? S(u, d) : v(d);
                                i[o].setAttribute("d", c);
                              }
                              n[a] = s;
                            }
        ...
        (n = e),
        window.addEventListener("resize", function () {
          clearTimeout(n.eventIds.resize), (n.eventIds.resize = setTimeout(a, 300));
        }),
        (e.loaded = !0));
    }
    function i(e) {
      ...
      e.options.xAxis &&
        ...
        e.svg.appendChild(t),
        L((n = e.element.getElementsByClassName("js-chart__axis-legend--x")[0])) && ((a = n.getBBox()), (s = e.width / 2 - a.width / 2), (i = e.height - e.bottomDelta), Util.setAttributes(n, { x: s, y: i }), (e.bottomDelta = e.bottomDelta + a.height + e.svgPadding))),
        e.options.xAxis && e.options.xAxis.labels && 1 < e.options.xAxis.labels.length
          ? ((r = e.options.xAxis.labels), (e.xAxisInterval = [0, e.options.xAxis.labels.length - 1]))
          : (r = (function (e) {
              var t = [],
                n = 0;
              if (e.options.xAxis && e.options.xAxis.range && e.options.xAxis.step) {
                ...
                for (var a = 0; a <= n; a++) t.push(e.options.xAxis.range[0] + e.options.xAxis.step * a);
                ...
                for (a = 0; a < e.options.datasets[0].data.length; a++) t.push(a);
              } else {
                for (var s = x(e, !1), i = w(e, !1), r = new C(s, i, 5), n = Math.ceil((r.getNiceUpperBound() - r.getNiceLowerBound()) / r.getTickSpacing()), a = 0; a <= n; a++) t.push(r.getNiceLowerBound() + r.getTickSpacing() * a);
                e.xAxisInterval = [r.getNiceLowerBound(), r.getNiceUpperBound()];
              }
              return t;
            })(e)),
        e.options.xAxis && e.options.xAxis.labelModifier && (r = b(r, e.options.xAxis.labelModifier));
      var o = document.createElementNS("http://www.w3.org/2000/svg", "g");
      Util.setAttributes(o, {
      ...
      for (var l, d = 0; d < r.length; d++) {
        ...
        Util.setAttributes(c, { class: u, "alignment-baseline": "middle" }), (c.textContent = r[d]), o.appendChild(c);
      }
      e.options.xAxis &&
        e.options.xAxis.line &&
      ...
      for (d = 0; d < h; d++) {
        ...
        Util.setAttributes(m, { class: g, "stroke-linecap": "square" }), o.appendChild(m);
      }
      e.svg.appendChild(o);
    }
    function r(e) {
      ...
      e.options.yAxis &&
        ...
        (((t = document.createElementNS("http://www.w3.org/2000/svg", "text")).textContent = e.options.yAxis.legend), t.setAttribute("class", "chart__axis-legend chart__axis-legend--y js-chart__axis-legend--y"), e.svg.appendChild(t), L((n = e.element.getElementsByClassName("js-chart__axis-legend--y")[0])) && ((a = n.getBBox().height), (s = e.leftDelta + a / 2), (i = e.topDelta), Util.setAttributes(n, { x: s, y: i }), (e.leftDelta = e.leftDelta + a + e.svgPadding))),
        e.options.yAxis && e.options.yAxis.labels && 1 < e.options.yAxis.labels.length
          ? ((r = e.options.yAxis.labels), (e.yAxisInterval = [0, e.options.yAxis.labels.length - 1]))
          : (r = (function (e) {
              var t = [],
                n = 0;
              if (e.options.yAxis && e.options.yAxis.range && e.options.yAxis.step) {
                ...
                for (var a = 0; a <= n; a++) t.push(e.options.yAxis.range[0] + e.options.yAxis.step * a);
                e.yAxisInterval = [e.options.yAxis.range[0], e.options.yAxis.range[1]];
              } else {
                var s = e.options.type && "column" == e.options.type && e.options.stacked;
                s &&
                  (function (e) {
                    e.datasetsSum = [];
                ...
                for (
                  ...
                  t.push(o.getNiceLowerBound() + o.getTickSpacing() * a);
                e.yAxisInterval = [o.getNiceLowerBound(), o.getNiceUpperBound()];
              }
              return t;
            })(e)),
        e.options.yAxis && e.options.yAxis.labelModifier && (r = b(r, e.options.yAxis.labelModifier));
      var o = document.createElementNS("http://www.w3.org/2000/svg", "g");
      Util.setAttributes(o, {
        class: "chart__axis-labels chart__axis-labels--y js-chart__axis-labels--y",
      });
      for (var l, d = r.length - 1; 0 <= d; d--) {
        var c = document.createElementNS("http://www.w3.org/2000/svg", "text"),
      ...
      e.options.yAxis &&
        ...
        o.appendChild(l));
      for (var h = e.options.xAxis && e.options.xAxis.hasOwnProperty("guides") && !e.options.xAxis.guides, d = 1; d < r.length; d++) {
        var m = document.createElementNS("http://www.w3.org/2000/svg", "rect");
        Util.setAttributes(m, { class: "chart__guides js-chart__guides" }),
          h &&
            Util.setAttributes(m, {
    ...
    function l(e) {
      var t = e.element.getElementsByClassName("js-chart__axis-labels--y")[0].querySelectorAll(".js-chart__axis-label"),
        n = L(t[0]),
        a = 0;
      n && (a = 0.5 * t[0].getBBox().height), (e.topDelta = e.topDelta + a + e.svgPadding), (e.yAxisHeight = e.height - e.topDelta - e.bottomDelta);
      for (var s = e.yAxisHeight / (t.length - 1), i = e.element.getElementsByClassName("js-chart__guides"), r = e.xAxisWidth + " " + 2 * (e.xAxisWidth + s), o = 0; o < t.length; o++) {
        var l = 0;
        n && (l = t[o].getBBox().width),
          Util.setAttributes(t[o], {
            x: e.leftDelta - l - 2 * e.svgPadding,
            y: e.topDelta + s * o,
          }),
          i[o] &&
            Util.setAttributes(i[o], {
              x: e.leftDelta,
              y: e.topDelta + s * o,
              height: s,
              width: e.xAxisWidth,
      ...
      0 < d.length &&
        Util.setAttributes(d[0], {
          x1: e.leftDelta,
          x2: e.leftDelta,
          y1: e.topDelta,
          y2: e.topDelta + e.yAxisHeight,
        });
      var c,
        u,
        h,
        m = e.element.getElementsByClassName("js-chart__axis-legend--y");
      0 < m.length &&
        L(m[0]) &&
        ((a = (c = m[0].getBBox()).height),
        (u = c.y + 0.5 * (e.yAxisHeight + c.width)),
        (h = c.x + a / 4),
        Util.setAttributes(m[0], {
          y: u,
          x: h,
          transform: "rotate(-90 " + (c.x + a) + " " + (u + a / 2) + ")",
        }));
    }
    function d(e) {
      var t = e.element.getElementsByClassName("js-chart__axis-labels--x")[0].querySelectorAll(".js-chart__axis-label"),
        ...
        a = 0,
        s = L(t[t.length - 1]);
      s && (a = t[t.length - 1].getBBox().width), "column" != e.options.type ? (e.rightDelta = e.rightDelta + 0.5 * a + e.svgPadding) : (e.rightDelta = e.rightDelta + 4), (e.xAxisWidth = e.width - e.leftDelta - e.rightDelta);
      var i = y(t, "height"),
        r = y(t, "width"),
      ...
      var l = 0,
        d = 0;
      s && (d = t[0].getBBox().height);
      for (var c = 0; c < t.length; c++) {
        var u = 0;
        s && (u = t[c].getBBox().width),
          Util.setAttributes(t[c], {
            y: e.height - e.bottomDelta - d / 2,
            x: e.leftDelta + o * c - u / 2,
          }),
          Util.setAttributes(n[c], {
            y1: e.height - e.bottomDelta - i - e.svgPadding,
            y2: e.height - e.bottomDelta - i - e.svgPadding + 5,
            x1: e.leftDelta + o * c,
            x2: e.leftDelta + o * c,
          }),
          (l = l + u + 4);
      ...
      "column" == e.options.type &&
        n[t.length] &&
        Util.setAttributes(n[t.length], {
          y1: e.height - e.bottomDelta - i - e.svgPadding,
          y2: e.height - e.bottomDelta - i - e.svgPadding + 5,
          x1: e.leftDelta + o * t.length,
          x2: e.leftDelta + o * t.length,
        }),
        l >= e.xAxisWidth
          ? ((e.xAxisLabelRotation = !0),
            (function (e, t, n) {
              for (var a = 0; a < e.length; a++) {
                var s = e[a].getBBox(),
                  i = parseFloat(e[a].getAttribute("x")) + s.width / 2,
                  r = parseFloat(e[a].getAttribute("y")) - n;
                Util.setAttributes(e[a], {
                  y: parseFloat(e[a].getAttribute("y")) - n,
                  transform: "rotate(-45 " + i + " " + r + ")",
                }),
                  t[a].setAttribute("transform", "translate(0 -" + n + ")");
              }
              t[e.length] && t[e.length].setAttribute("transform", "translate(0 -" + n + ")");
            })(t, n, r - i),
            (i = r))
          : (e.xAxisLabelRotation = !1),
        (e.bottomDelta = e.bottomDelta + e.svgPadding + i);
      var h = e.element.getElementsByClassName("js-chart__axis--x");
      0 < h.length &&
        Util.setAttributes(h[0], {
          x1: e.leftDelta,
          x2: e.width - e.rightDelta,
          y1: e.height - e.bottomDelta,
          y2: e.height - e.bottomDelta,
        });
      var m = e.element.getElementsByClassName("js-chart__axis-legend--x");
      0 < m.length && L(m[0]) && m[0].setAttribute("x", e.leftDelta + 0.5 * (e.xAxisWidth - m[0].getBBox().width));
    }
    function c(e, t) {
      for (
        var n =
          ...
          a = e.xAxisWidth / (n.length - 1) - e.xAxisWidth / n.length,
          s = 0;
        s < n.length;
        s++
      ) {
        var i = e.leftDelta + (e.xAxisWidth * (n[s][0] - e.xAxisInterval[0])) / (e.xAxisInterval[1] - e.xAxisInterval[0]),
          r = e.height - e.bottomDelta - (e.yAxisHeight * (n[s][1] - e.yAxisInterval[0])) / (e.yAxisInterval[1] - e.yAxisInterval[0]);
        "column" == e.options.type && (i -= s * a), (n[s] = [i, r]);
      }
      return n;
    }
    function v(e) {
    ...
    function u(e, t) {
      for (var n = p(e), a = 0; a < e.datasetScaledFlat[t].length; a++) e.datasetScaledFlat[t][a] = [e.datasetScaled[t][a][0], n];
      "area" == e.options.type && (e.datasetAreaScaledFlat[t] = m(e, e.datasetScaledFlat[t]));
    }
    function g(e, t) {
      var n = "",
        a = e.length,
      ...
      t && ((a -= 3), s.splice(-3, 3));
      for (var i, r, o, l, d, c = 0; c < a; c++) n = 0 == c ? "M " + e[0][0] + "," + e[0][1] : n + " " + ((i = e[c]), (d = l = void 0), (l = h((o = s)[(r = c) - 1], o[r - 2], i)), (d = h(i, o[r - 1], o[r + 1], !0)), "C " + l[0] + "," + l[1] + " " + d[0] + "," + d[1] + " " + i[0] + "," + i[1]);
      if (t) for (var u = a; u < e.length; u++) n = n + " L " + e[u][0] + "," + e[u][1];
      return n;
    }
    function h(e, t, n, a) {
      var s,
    ...
    function m(e, t) {
      var n = JSON.parse(JSON.stringify(t)),
        ...
        s = n[n.length - 1],
        i = p(e);
      return n.push([s[0], i]), n.push([e.leftDelta, i]), n.push([e.leftDelta, a[1]]), n;
    }
    function p(e) {
    ...
    function f(e, t, n) {
      var a = document.createElementNS("http://www.w3.org/2000/svg", "g"),
        s = 0;
      "column" == e.options.type && (s = (0.5 * e.xAxisWidth) / t.length);
      for (var i = 0; i < t.length; i++) {
        var r = document.createElementNS("http://www.w3.org/2000/svg", "circle");
        Util.setAttributes(r, {
          class: "chart__marker js-chart__marker chart__marker--" + (n + 1),
          cx: t[i][0] + s,
          cy: t[i][1],
          r: 2,
          "data-set": n,
    ...
    function x(e, t) {
      for (var n = [], a = 0; a < e.options.datasets.length; a++)
        n.push(
          (function (e, t) {
            for (var n, a, s = 1 < e[0].length, i = 0; i < e.length; i++) (a = s ? (t ? e[i][1] : e[i][0]) : e[i]), (0 == i || a < n) && (n = a);
            return n;
          })(e.options.datasets[a].data, t)
        );
    ...
    function w(e, t) {
      for (var n = [], a = 0; a < e.options.datasets.length; a++)
        n.push(
          (function (e, t) {
            for (var n, a, s = 1 < e[0].length, i = 0; i < e.length; i++) (a = s ? (t ? e[i][1] : e[i][0]) : e[i]), (0 == i || n < a) && (n = a);
            return n;
          })(e.options.datasets[a].data, t)
        );
    ...
    function C(e, t, n) {
      var a,
        ...
        o = n || 10;
      function l() {
        (s = d(t - e, !1)), (a = d(s / (o - 1), !0)), (i = Math.floor(e / a) * a), (r = Math.ceil(t / a) * a);
      }
      function d(e, t) {
        var n = Math.floor(Math.log(e) * Math.LOG10E),
          a = e / Math.pow(10, n),
          s = t ? (a < 1.5 ? 1 : a < 3 ? 2 : a < 7 ? 5 : 10) : a <= 1 ? 1 : a <= 2 ? 2 : a <= 5 ? 5 : 10;
        return s * Math.pow(10, n);
      }
      l(),
    ...
    function _(e) {
      if (D) {
        (e.markers = []), (e.bars = []);
        for (var t, n, a = e.element.getElementsByClassName("js-chart__set"), s = 0; s < a.length; s++) (e.markers[s] = a[s].querySelectorAll(".js-chart__marker")), e.options.type && "column" == e.options.type && (e.bars[s] = a[s].querySelectorAll(".js-chart__data-bar"));
        e.options.yIndicator &&
          ...
          Util.setAttributes(t, {
            ...
            x2: 0,
            y2: e.topDelta + e.yAxisHeight,
            transform: "translate(" + e.leftDelta + " " + e.topDelta + ")",
            class: "chart__y-indicator js-chart__y-indicator is-hidden",
          }),
          e.svg.insertBefore(t, e.element.getElementsByClassName("js-chart__dataset")[0]),
          (e.interLine = e.element.getElementsByClassName("js-chart__y-indicator")[0])),
    ...
    function E(e, t) {
      var n, a, s, i, r, o, l, d, c;
      e.hovering ||
        ((e.options.yIndicator || e.tooltipOn) &&
          !(e.hovering = !0) !==
            (n = (function (e, t) {
              if (e.markers[0].length < 1) return !1;
              for (var n = (t.detail.x ? t.detail.x : t.clientX) - e.svg.getBoundingClientRect().left, a = 0, s = Math.abs(e.markers[0][0].getBBox().x - n), i = 1; i < e.markers[0].length; i++) {
                var r = Math.abs(e.markers[0][i].getBBox().x - n);
                r < s && ((s = r), (a = i));
              }
              return a;
            })(e, t)) &&
          (n !== e.selectedMarker &&
            ...
            A(e, !0),
            k(e, !0),
            (a = e.markers[0][e.selectedMarker].getBBox()),
            e.options.yIndicator && (Util.removeClass(e.interLine, "is-hidden"), e.interLine.setAttribute("transform", "translate(" + (a.x + a.width / 2) + " 0)")),
            e.tooltipOn &&
              ...
              (d.tooltip.innerHTML = (function (e, t, n) {
                ...
                {
                  var s;
                  a = e.options.tooltip.customHTML ? e.options.tooltip.customHTML(t, e.options, n) : ((s = 1 < e.options.datasets[n].data[t].length), e.options.xAxis && e.options.xAxis.labels && 1 < e.options.xAxis.labels.length ? (a = e.options.xAxis.labels[t] + " - ") : s && (a = e.options.datasets[n].data[t][0] + " - "), s ? a + e.options.datasets[n].data[t][1] : a + e.options.datasets[n].data[t]);
                }
                return a;
              })(d, c.getAttribute("data-index"), c.getAttribute("data-set"))),
              (i = (s = e).markers[0][s.selectedMarker]),
              (r = i.getBoundingClientRect()),
              (o = i.getBBox()),
              (l = s.svg.getBoundingClientRect()),
              "column" == s.options.type
                ? (function (e, t, n, a) {
                    (e.tooltip.style.left = a.x + n.width / 2 + "px"),
                      ...
                      e.tooltipPosition
                        ...
                        ? ((e.tooltip.style.top = a.y + a.height + 6 + "px"), (e.tooltip.style.transform = "translateX(-50%)"))
                        : (e.tooltip.style.top = a.y - 6 + "px");
                  })(s, i, r, o)
                : (function (e, t, n, a, s) {
                    t.left - a <= s / 2 ? ((e.tooltip.style.left = n.x + n.width + 2 + "px"), (e.tooltip.style.right = "auto")) : ((e.tooltip.style.left = "auto"), (e.tooltip.style.right = s - n.x + 2 + "px")), (e.tooltip.style.transform = "translateY(-100%)");
                  ...
                  })(s, r, o, l.left, l.width))),
          (function (e) {
            if (!e.extDataX || !e.extDataY) return;
            var t = e.markers[0][e.selectedMarker];
            if (!t) return;
            for (var n = t.getAttribute("data-index"), a = 1 < e.options.datasets[0].data[0].length, s = 0; s < e.options.datasets.length; s++)
              !(function (e, t, n, a) {
                if (!e.extDataX[n] || !e.extDataX[n][0]) return;
                var s = "";
                e.options.externalData.customXHTML ? (s = e.options.externalData.customXHTML(t, e.options, n)) : e.options.xAxis && e.options.xAxis.labels && 1 < e.options.xAxis.labels.length ? (s = e.options.xAxis.labels[t]) : a && (htmlContent = e.options.datasets[n].data[t][0]);
                e.extDataX[n][0].innerHTML = s;
              })(e, n, s, a),
                (function (e, t, n, a) {
                  if (!e.extDataY[n] || !e.extDataY[n][0]) return;
                  var s = "";
                  s = e.options.externalData.customYHTML ? e.options.externalData.customYHTML(t, e.options, n) : a ? e.options.datasets[n].data[t][1] : e.options.datasets[n].data[t];
                  e.extDataY[n][0].innerHTML = s;
                })(e, n, s, a);
          })(e),
          (e.hovering = !1)));
    }
    ...
    function I(l, d) {
      var c = null,
        u = l.datasetScaledFlat,
        h = l.datasetScaled;
      "fill" == d && ((u = l.datasetAreaScaledFlat), (h = l.datasetAreaScaled));
      var m = function (e) {
        var t = e - (c = c || e);
        600 < t && (t = 600);
        for (var n = 0; n < h.length; n++) {
          for (var a = [], s = l.element.getElementsByClassName("js-chart__data-" + d + "--" + (n + 1))[0], i = 0; i < h[n].length; i++) {
            var r = Math.easeOutQuart(t, u[n][i][1], h[n][i][1] - u[n][i][1], 600);
            a[i] = [h[n][i][0], r];
          }
          var o = l.options.smooth ? g(a, "fill" == d) : v(a);
          s.setAttribute("d", o);
        }
        t < 600 && window.requestAnimationFrame(m);
      };
    ...
    function a(e, t, n) {
      for (var a = 0; a < t.length; a++) (n[a] = []), t[a][0] && (n[a][0] = t[a][0].innerHTML);
    }
    function M(e, t, n, a, s) {
      var i = e.columnDelta + n * (e.columnWidth + e.columnGap),
        r = 0;
      return (
        e.options.stacked &&
          ((i = e.columnDelta),
          (r = (function (e, t, n, a) {
            for (var s = 0, i = 0; i < n; i++) t[i] && t[i][a] && (s += e.height - e.bottomDelta - t[i][a][1]);
            return s;
          })(e, s, n, a))),
        [
          [t[0] + i, e.yZero - r],
          [t[0] + i, t[1] - r],
          [t[0] + i + e.columnWidth, t[1] - r],
          [t[0] + i + e.columnWidth, e.yZero - r],
        ]
      );
    }
    function S(e, t) {
      var n = parseInt(e.options.column.radius),
        ...
        i = ",",
        r = t[1][1] + n;
      e.yAxisInterval[0] < 0 && t[1][1] > e.yZero && ((a = "0,0,0"), (s = ","), (i = "-"), (r = t[1][1] - n));
      var o = "M " + t[0][0] + " " + t[0][1];
      return (o = (o = (o = (o = (o = o + " V " + r) + " a " + n + "," + n + "," + a + "," + n + s + n) + " H " + (t[2][0] - n)) + " a " + n + "," + n + "," + a + "," + n + i + n) + " V " + t[3][1]);
    }
    (n.defaults = {
      element: "",
      type: "line",
      ...
      yAxis: {},
      datasets: [],
      tooltip: { enabled: !1, classes: !1, customHTM: !1 },
      yIndicator: !0,
      padding: 10,
    }),
      (window.Chart = n);
    var D = "IntersectionObserver" in window && "IntersectionObserverEntry" in window && "intersectionRatio" in window.IntersectionObserverEntry.prototype;
  })(),
  (function () {
    function e(e) {
      var t;
      (this.options = Util.extend(DatePicker.defaults, e)),
        ...
        (function (l) {
          l.trigger &&
            l.trigger.addEventListener("click", function (e) {
              var t, n;
              (l.pickerVisible = !1), (t = l).pickerVisible ? c(t) : (s(t), d(t, n)), l.trigger.setAttribute("aria-expanded", "true");
            });
          l.navigation.addEventListener("click", function (e) {
            e.preventDefault();
            var t = e.target.closest(".js-date-picker__month-nav-btn");
            t && (Util.hasClass(t, "js-date-picker__month-nav-btn--prev") ? o : r)(l, !0);
          }),
            window.addEventListener("keydown", function (e) {
              if ((e.keyCode && 27 == e.keyCode) || (e.key && "escape" == e.key.toLowerCase())) {
                if (!l.pickerVisible) return;
                document.activeElement.closest(".js-date-picker") && l.trigger.focus(), c(l);
              }
            }),
            window.addEventListener("click", function (e) {
              e.target.closest(".js-date-picker") || e.target.closest(".js-date-range__trigger") || !l.pickerVisible || c(l);
            }),
            l.body.addEventListener("keydown", function (e) {
              ...
              (e.keyCode && 40 == e.keyCode) || (e.key && "arrowdown" == e.key.toLowerCase())
                ...
                ? y((t -= 7), l)
                : (e.keyCode && 35 == e.keyCode) || (e.key && "end" == e.key.toLowerCase())
                ? (e.preventDefault(), y((t = t + 6 - v(l.currentYear, l.currentMonth, t)), l))
                : (e.keyCode && 36 == e.keyCode) || (e.key && "home" == e.key.toLowerCase())
                ? (e.preventDefault(), y((t -= v(l.currentYear, l.currentMonth, t)), l))
                : (e.keyCode && 34 == e.keyCode) || (e.key && "pagedown" == e.key.toLowerCase())
                ? (e.preventDefault(), r(l), M(l))
                : ((e.keyCode && 33 == e.keyCode) || (e.key && "pageup" == e.key.toLowerCase())) && (e.preventDefault(), o(l), M(l));
            }),
            l.datePicker.addEventListener("keydown", function (e) {
              ((e.keyCode && 9 == e.keyCode) || (e.key && "Tab" == e.key)) &&
                (function (e, t) {
                  t.firstFocusable == document.activeElement && e.shiftKey && (e.preventDefault(), t.lastFocusable.focus());
                  t.lastFocusable != document.activeElement || e.shiftKey || (e.preventDefault(), t.firstFocusable.focus());
            ...
            l.body.addEventListener("click", function (e) {
              ...
              o &&
                (1 == l.dateToSelect && ((s = o), (i = [(a = l).currentYear, a.currentMonth, parseInt(s.textContent)]), (r = [a.selectedYear[0], a.selectedMonth[0], a.selectedDay[0]]), L(i, r)) && (l.dateToSelect = 0),
                (l.dateSelected[l.dateToSelect] = !0),
                (l.selectedDay[l.dateToSelect] = parseInt(o.innerText)),
                (l.selectedMonth[l.dateToSelect] = l.currentMonth),
                (l.selectedYear[l.dateToSelect] = l.currentYear),
                0 == l.dateToSelect
                  ? (((n = l).inputStart.value = f(n, 0)),
                    (l.dateToSelect = 1),
                    (function (e, t) {
                      ...
                      var a = e.element.getElementsByClassName("js-date-picker__date--range-end");
                      0 < a.length && Util.removeClass(a[0], e.selectedEndClass);
                      I(e), Util.addClass(t, e.selectedStartClass);
                    })(l, o))
                  : (((t = l).inputEnd.value = f(t, 1)), (l.dateToSelect = 0), c(l)),
                w(l),
                C(l),
                E(l));
            }),
            l.body.addEventListener("mousemove", function (e) {
              var t = e.target.closest(".js-date-picker__date");
              t && l.dateSelected[0] && !l.dateSelected[1] && A(l, t);
            }),
            l.body.addEventListener("mouseleave", function (e) {
              l.dateSelected[1] || (I(l), S(l));
            }),
            l.inputStart.addEventListener("focusout", function (e) {
              a(l, l.inputStart);
            }),
            l.inputEnd.addEventListener("focusout", function (e) {
              a(l, l.inputEnd);
            });
        })(this),
        D(this),
        (function (t) {
          ...
          n.addEventListener("change", function (e) {
            "custom" == n.options[n.selectedIndex].value ? (Util.removeClass(t.element, "is-hidden"), D(t), t.trigger.focus()) : Util.addClass(t.element, "is-hidden");
          });
        })(this);
    }
    function n(e) {
    ...
    function a(e, t) {
      var n = l(e, t.value);
      !n || isNaN(new Date(n).getTime()) ? (t.value = "") : s(e);
    }
    function s(e) {
      t(e, 0), t(e, 1), w(e), C(e), E(e);
    }
    function t(e, t) {
      var n,
        a = !1,
        s = 0 == t ? e.inputStart.value : e.inputEnd.value;
      (e.dateSelected[t] = !1), "" != s && ((n = l(e, s)), (e.dateSelected[t] = !0), (a = n)), 0 == t && ((e.currentDay = u(a)), (e.currentMonth = h(a)), (e.currentYear = m(a))), (e.selectedDay[t] = !!e.dateSelected[t] && u(a)), (e.selectedMonth[t] = !!e.dateSelected[t] && h(a)), (e.selectedYear[t] = !!e.dateSelected[t] && m(a));
    }
    function u(e) {
    ...
    function h(e) {
      return e ? ((t = parseInt(e.split("-")[1]) - 1), isNaN(t) ? h(!1) : t) : new Date().getMonth();
      var t;
    }
    function m(e) {
      return e ? ((t = parseInt(e.split("-")[0])), isNaN(t) ? m(!1) : t) : new Date().getFullYear();
      var t;
    }
    function r(e, t) {
      (e.currentYear = 11 === e.currentMonth ? e.currentYear + 1 : e.currentYear), (e.currentMonth = (e.currentMonth + 1) % 12), (e.currentDay = i(e)), d(e, t), (e.srLiveReagionM.textContent = e.options.months[e.currentMonth] + " " + e.currentYear);
    }
    function o(e, t) {
      (e.currentYear = 0 === e.currentMonth ? e.currentYear - 1 : e.currentYear), (e.currentMonth = 0 === e.currentMonth ? 11 : e.currentMonth - 1), (e.currentDay = i(e)), d(e, t), (e.srLiveReagionM.textContent = e.options.months[e.currentMonth] + " " + e.currentYear);
    }
    function i(e) {
    ...
    function d(e, t) {
      ...
      (e.body.innerHTML = ""), (e.heading.innerHTML = e.options.months[e.currentMonth] + " " + e.currentYear);
      for (var a, s, i = 1, r = "", o = 0; o < 6; o++)
        for (var l = 0; l < 7; l++)
          if (0 === o && l < n) r += "<li></li>";
          else {
            if (i > g(e.currentYear, e.currentMonth)) break;
            var d = "",
              c = "-1";
            i === e.currentDay && (c = "0"),
              e.dateSelected[0] || e.dateSelected[1] || h() != e.currentMonth || m() != e.currentYear || i != u() || (d += " date-picker__date--today"),
              e.dateSelected[0] && i === e.selectedDay[0] && e.currentYear === e.selectedYear[0] && e.currentMonth === e.selectedMonth[0] && (d = d + "  " + e.selectedStartClass),
              e.dateSelected[1] && i === e.selectedDay[1] && e.currentYear === e.selectedYear[1] && e.currentMonth === e.selectedMonth[1] && (d = d + "  " + e.selectedEndClass),
              (r = r + '<li><button class="date-picker__date' + d + ' js-date-picker__date" tabindex="' + c + '">' + i + "</button></li>"),
              i++;
          }
      (e.body.innerHTML = r),
        ...
        x(e),
        e.dateSelected[1] &&
          (0 < (a = e.element.getElementsByClassName("js-date-picker__date--range-end")).length
            ? k(e, a[0])
            : (function (e) {
                var t = !1,
                  n = !1;
                ...
                return t && n;
              })(e) && ((s = e.element.getElementsByClassName("js-date-picker__date")), k(e, s[s.length - 1]))),
        p(e, !0);
    }
    function p(e, t) {
      e.triggerLabelWrapper.length < 1 || e.triggerLabelWrapper[0].children.length < 2 || (t ? (Util.addClass(e.triggerLabelWrapper[0].children[0], "is-hidden"), Util.removeClass(e.triggerLabelWrapper[0].children[1], "is-hidden"), D(e)) : e.dateSelected[0] || e.dateSelected[1] || (Util.addClass(e.triggerLabelWrapper[0].children[1], "is-hidden"), Util.removeClass(e.triggerLabelWrapper[0].children[0], "is-hidden")));
    }
    function c(e) {
    ...
    function y(e, t) {
      ...
      if (n < e) (t.currentDay = e - n), r(t, !1), M(t);
      else if (e < 1) {
        var a = 0 == t.currentMonth ? 11 : t.currentMonth - 1;
        (t.currentDay = g(t.currentYear, a) + e), o(t, !1), M(t);
      } else {
        (t.currentDay = e), t.body.querySelector('button[tabindex="0"]').setAttribute("tabindex", "-1");
        for (var s = t.body.getElementsByTagName("button"), i = 0; i < s.length; i++)
          if (s[i].textContent == t.currentDay) {
    ...
    function C(e) {
      0 < e.dateValueStartEl.length && _(e, 0, e.dateValueStartEl[0], e.dateValueStartElLabel), 0 < e.dateValueEndEl.length && _(e, 1, e.dateValueEndEl[0], e.dateValueEndElLabel);
    }
    function _(e, t, n, a) {
      e.selectedYear[t] && e.selectedMonth[t] && e.selectedDay[t] ? (n.textContent = f(e, t)) : (n.textContent = a);
    }
    function E(e) {
      var t = !1;
    ...
    var N,
      B,
      j = document.getElementsByClassName("js-date-range");
    if (0 < j.length)
      for (var F = 0; F < j.length; F++)
        (B = void 0),
          (B = { element: j[(N = F)] }),
          j[N].getAttribute("data-date-format") && (B.dateFormat = j[N].getAttribute("data-date-format")),
          j[N].getAttribute("data-date-separator") && (B.dateSeparator = j[N].getAttribute("data-date-separator")),
          j[N].getAttribute("data-months") &&
            (B.months = j[N].getAttribute("data-months")
              .split(",")
              .map(function (e) {
                return e.trim();
              })),
        ...
        this.element.addEventListener("keydown", function (e) {
          ...
          this.element.addEventListener("keyup", function (e) {
            if ((e.keyCode && 9 == e.keyCode) || (e.key && "Tab" == e.key)) {
              ...
              if ((n && !Util.hasClass(n, "dropdown__menu--is-visible") && o.showLevel(n), a && !Util.hasClass(a, "dropdown__menu--is-visible") && o.showLevel(a), !o.prevFocus)) return;
              var s = o.prevFocus.closest(".js-dropdown__menu"),
                i = o.prevFocus.nextElementSibling;
              if (!s) return;
              if (n && n == s) return void (i && o.hideLevel(i));
              if (i && n && n == i) return;
              if (a && s && a == s) return;
              var r = n.parentNode.closest(".js-dropdown__menu");
              if (r && r == s) return void (i && o.hideLevel(i));
              s && Util.hasClass(s, "dropdown__menu--is-visible") && o.hideLevel(s);
            }
          });
      }),
  ...
  (function () {
      ...
      (this.element = e),
        ...
        (function (t) {
          (function (e) {
            ...
            (function (e) {
              ...
              for (var n = 0; n < e.mobHideItems.length; n++) {
                var a = e.mobHideItems[n].cloneNode(!0),
                  s = a.getElementsByTagName("svg")[0],
                  i = a.getElementsByClassName("menu-bar__label")[0];
                s.setAttribute("class", "icon menu__icon"), (t = t + '<li role="menuitem"><span class="menu__content js-menu__content">' + s.outerHTML + "<span>" + i.innerHTML + "</span></span></li>");
              }
              Util.setAttributes(e.moreItemsTrigger[0], {
                role: "button",
                "aria-expanded": "false",
                "aria-controls": e.menuControlId,
                "aria-haspopup": "true",
              });
              var r = document.createElement("menu"),
                o = e.element.getAttribute("data-menu-class");
              Util.setAttributes(r, {
                id: e.menuControlId,
                class: "menu js-menu " + o,
              }),
                (r.innerHTML = t),
                document.body.appendChild(r),
                (e.subMenu = r),
                (e.subItems = r.getElementsByTagName("li")),
          ...
          t.element.addEventListener("keydown", function (e) {
            (e.keyCode && 39 == e.keyCode) || (e.key && "arrowright" == e.key.toLowerCase()) ? r(t.items, e, "next") : ((e.keyCode && 37 == e.keyCode) || (e.key && "arrowleft" == e.key.toLowerCase())) && r(t.items, e, "prev");
          });
        })(this);
    }
    function n(e) {
    ...
    function r(e, t, n, a) {
      t.preventDefault();
      var s = void 0 !== a ? a : Util.getIndexInArray(e, t.target),
        i = "next" == n ? s + 1 : s - 1;
      i < 0 && (i = e.length - 1), i > e.length - 1 && (i = 0), null === e[i].offsetParent ? r(e, t, n, i) : Util.moveFocus(e[i]);
    }
    var t = document.getElementsByClassName("js-menu-bar");
    if (0 < t.length) {
      for (var a, s, i = 0, o = [], l = 0; l < t.length; l++) {
        var d = getComputedStyle(t[l], ":before").getPropertyValue("content");
        d && "" != d && "none" != d && (o.push(new e(t[l])), (i += 1));
      }
      function c() {
      ...
      0 < i &&
        ((a = !1),
        (s = new CustomEvent("update-menu-bar")),
        window.addEventListener("resize", function (e) {
          clearTimeout(a), (a = setTimeout(c, 150));
        }),
        window.addEventListener("click", function (a) {
          o.forEach(function (e) {
            var t, n;
            (t = e), (n = a.target), !t.menuInstance || t.moreItemsTrigger[0].contains(n) || t.subMenu.contains(n) || t.menuInstance.toggleMenu(!1, !1);
          });
        }));
    }
  })(),
  (function () {
    ...
    e &&
      new Chart({
        element: e,
        type: "area",
        xAxis: { labels: !1, guides: !1 },
        yAxis: { labels: !1, range: [0, 16], step: 1 },
        datasets: [{ data: [1, 2, 3, 12, 8, 7, 10, 4, 9, 5, 16, 3] }],
        tooltip: { enabled: !0 },
        padding: 6,
        animate: !0,
      });
    var t = document.getElementById("stats-card-chart-2");
    t &&
      new Chart({
        element: t,
        type: "area",
        xAxis: { labels: !1, guides: !1 },
        yAxis: { labels: !1, range: [0, 11], step: 1 },
        datasets: [{ data: [8, 5, 6, 10, 8, 4, 5, 6, 11, 5, 7, 4] }],
        tooltip: { enabled: !0 },
        padding: 6,
        animate: !0,
      });
    var n = document.getElementById("stats-card-chart-3");
    n &&
      new Chart({
        element: n,
        type: "area",
        xAxis: { labels: !1, guides: !1 },
        yAxis: { labels: !1, range: [0, 16], step: 1 },
        datasets: [{ data: [8, 12, 6, 15, 10, 8, 15, 8, 12, 7, 16, 13] }],
        tooltip: { enabled: !0 },
        padding: 6,
        animate: !0,
      });
    var a = document.getElementById("stats-card-chart-4");
    a &&
      new Chart({
        element: a,
        type: "area",
        xAxis: { labels: !1, guides: !1 },
        yAxis: { labels: !1, range: [0, 16], step: 1 },
        datasets: [{ data: [5, 16, 3, 2, 9, 7, 16, 3, 10, 4, 9, 5] }],
        tooltip: { enabled: !0 },
        padding: 6,
        animate: !0,
      });
    var s = document.getElementById("area-chart-card-1");
    s &&
      new Chart({
        element: s,
        type: "area",
    ...
    var i = document.getElementById("area-chart-card-2");
    i &&
      new Chart({
        element: i,
        type: "area",
    ...
    var r = document.getElementById("area-chart-card-3");
    r &&
      new Chart({
        element: r,
        type: "area",
        ...
        tooltip: {
          ...
          position: "top",
          customHTML: function (e, t, n) {
            var a = '<p class="margin-bottom-xxs">Total ' + t.xAxis.labels[e] + "</p>";
            return (a = (a = a + '<p class="flex items-center"><span class="height-xxxs width-xxxs radius-50% bg-primary margin-right-xxs"></span>$' + t.datasets[0].data[e] + "</p>") + '<p class="flex items-center"><span class="height-xxxs width-xxxs radius-50% bg-accent margin-right-xxs"></span>$' + t.datasets[1].data[e] + "</p>");
          },
        },
        animate: !0,
      });
    var o = document.getElementById("area-chart-card-4");
    o &&
      new Chart({
        element: o,
        type: "area",
    ...
    var l = document.getElementById("column-chart-1");
    l &&
      new Chart({
        element: l,
        type: "column",
    ...
    var d = document.getElementById("column-chart-2");
    d &&
      new Chart({
        element: d,
        type: "column",
    ...
    var c = document.getElementById("column-chart-3");
    c &&
      new Chart({
        element: c,
        type: "column",
        ...
        tooltip: {
          ...
          customHTML: function (e, t, n) {
            var a = '<p class="margin-bottom-xxs">Total ' + t.xAxis.labels[e] + "</p>";
            return (a = (a = a + '<p class="flex items-center"><span class="height-xxxs width-xxxs radius-50% bg-primary margin-right-xxs"></span>$' + t.datasets[0].data[e] + "</p>") + '<p class="flex items-center"><span class="height-xxxs width-xxxs radius-50% bg-contrast-higher margin-right-xxs"></span>$' + t.datasets[1].data[e] + "</p>");
          },
          position: "top",
        },
        animate: !0,
      });
    var u = document.getElementById("column-chart-4");
    u &&
      new Chart({
        element: u,
        type: "column",
    ...
    var h = document.getElementById("line-chart-1");
    h &&
      new Chart({
        element: h,
        type: "line",
    ...
    var m,
      g = document.getElementById("line-chart-2");
    function p(e) {
      var t = new Date(e),
        n = t.getDate(),
        a = t.getMonth();
    ...
    g &&
      ...
      new Chart({
        ...
        tooltip: {
          enabled: !0,
          customHTML: function (e, t, n) {
            return '<span class="color-contrast-medium">' + p(t.datasets[n].data[e][0]) + " - </span> " + t.datasets[n].data[e][1] + "°C";
          },
        },
        animate: !0,
      }));
    var v = document.getElementById("line-chart-3");
    v &&
      new Chart({
        element: v,
        type: "line",
    ...
    var f = document.getElementById("line-chart-4");
    f &&
      new Chart({
        element: f,
        type: "line",
  ...
  (function () {
    var s = document.getElementsByClassName("js-app-ui");
    if (0 < s.length) {
      var n = s[0].getElementsByClassName("js-app-ui__menu-btn");
      if (n.length < 1) return;
      var a = "app-ui--nav-expanded",
        i = !1,
        r = !1;
      n[0].addEventListener("click", function (e) {
        var t = !Util.hasClass(s[0], a);
        Util.toggleClass(s[0], a, t),
          n[0].setAttribute("aria-expanded", t),
          t
            ? (i = (function () {
                var e = s[0].getElementsByClassName("js-app-ui__nav");
                if (e.length < 1) return !1;
                for (var t = e[0].querySelectorAll('[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex]:not([tabindex="-1"]), [controls], summary'), n = !1, a = 0; a < t.length; a++)
                  if (t[a].offsetWidth || t[a].offsetHeight || t[a].getClientRects().length) {
                    n = t[a];
                    break;
                  }
                return n;
        ...
        window.addEventListener("keyup", function (e) {
          ((e.keyCode && 27 == e.keyCode) || (e.key && "escape" == e.key.toLowerCase())) && "true" == n[0].getAttribute("aria-expanded") && o(n[0]) && ((r = n[0]), n[0].click()), ((e.keyCode && 9 == e.keyCode) || (e.key && "tab" == e.key.toLowerCase())) && "true" == n[0].getAttribute("aria-expanded") && o(n[0]) && !document.activeElement.closest(".js-app-ui__nav") && n[0].click();
        });
      var e = !1;
      function t() {
        !o(n[0]) && Util.hasClass(s[0], a) && n[0].click();
      }
      function o(e) {
        return e.offsetWidth || e.offsetHeight || e.getClientRects().length;
      }
  ...
  (function () {
              ...
              (t.selectAll = e[0]),
                ...
                t.body.addEventListener("change", function (e) {
                  e.target.closest(".js-int-table__select-row") &&
                    (function (e) {
                      for (var t = !0, n = !1, a = 0; a < e.selectRow.length; a++) e.selectRow[a].checked ? (n = !0) : (t = !1), Util.toggleClass(e.selectRow[a].closest(".int-table__row"), "int-table__row--checked", e.selectRow[a].checked);
                      (e.selectAll.checked = n), t || (e.selectAll.indeterminate = n);
                      s(e, n);
                    })(t);
                }),
                s(t, 0 < t.element.getElementsByClassName("int-table__row--checked").length);
            })(n, e);
          (n.sortableCols = n.element.getElementsByClassName("js-int-table__cell--sort")),
            0 < n.sortableCols.length &&
              ...
              n.header.addEventListener("click", function (e) {
                ...
                t && "input" != e.target.tagName.toLowerCase() && a(n, t);
              }),
              n.header.addEventListener("change", function (e) {
                var t = e.target.closest(".js-int-table__cell--sort");
                t && a(n, t, e.target.value);
              }),
    ...
    function a(e, t, n) {
      var a,
        s = n || ((a = t), Util.hasClass(a, "int-table__cell--asc") ? "desc" : Util.hasClass(a, "int-table__cell--desc") ? "none" : "asc");
      !(function (e, t, n, a) {
        var s = e.body.getElementsByTagName("tr"),
          i = !0,
          r = 0;
        for (; i; )
          for (i = !1, r = 0; r < s.length - 1; r++) {
            var o = "none" == t ? s[r].getAttribute("data-order") : s[r].children[n].textContent.trim(),
              l = "none" == t ? s[r + 1].getAttribute("data-order") : s[r + 1].children[n].textContent.trim();
            if (
              (function (e, t, n, a) {
                var s,
                  i = a.getAttribute("data-date-format");
                s = i && "none" != n ? ("asc" == n || "none" == n ? d(e, i) > d(t, i) : d(t, i) > d(e, i)) : isNaN(e) || isNaN(t) ? ("asc" == n || "none" == n ? t.toString().localeCompare(e) < 0 : e.toString().localeCompare(t) < 0) : "asc" == n || "none" == n ? Number(e) > Number(t) : Number(t) > Number(e);
                return s;
              })(o, l, t, a)
            ) {
              e.body.insertBefore(s[r + 1], s[r]), (i = !0);
              break;
            }
          }
      })(e, s, Util.getIndexInArray(e.headerCols, t), t);
      for (var i = 0; i < e.headerCols.length; i++) Util.removeClass(e.headerCols[i], "int-table__cell--asc int-table__cell--desc");
      "asc" == s && Util.addClass(t, "int-table__cell--asc"), "desc" == s && Util.addClass(t, "int-table__cell--desc"), n || (t.querySelector('input[value="' + s + '"]').checked = !0);
    }
    function d(e, t) {
      var n = e.match(/(\d+)/g),
        a = 0,
      ...
      return (
        ...
        new Date(n[s.yyyy], n[s.mm] - 1, n[s.dd])
      );
    }
    function s(e, t) {
